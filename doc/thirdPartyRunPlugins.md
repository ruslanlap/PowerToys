...
| [VideoDownloader](https://github.com/ruslanlap/PowerToysRun-VideoDownloader) | [ruslanlap](https://github.com/ruslanlap) | Download videos from various platforms (primarily YouTube) with quality selection and post-download actions. |